"""Spotify metadata provider plugin."""
...
class SpotifyPlugin(BaseMetadataProvider, MetadataProviderPlugin):
    """Metadata provider plugin backed by Spotify Web API."""
