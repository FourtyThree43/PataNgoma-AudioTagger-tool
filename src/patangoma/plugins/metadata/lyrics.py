"""Lyrics retrieval and synchronized LRC metadata provider plugin."""
...
class LyricsPlugin(BaseMetadataProvider, MetadataProviderPlugin, LyricsProviderPlugin):
    """Lyrics provider plugin backed by LrcLib open-source REST API."""
    ...
    def capabilities(self) -> set[PluginCapability]:
        return {PluginCapability.METADATA, PluginCapability.LYRICS}
    ...
    def fetch_lyrics_pair(
        ...
        """Alias for fetch_lyrics returning (plain_lyrics, synced_lyrics)."""
        return self.fetch_lyrics(
