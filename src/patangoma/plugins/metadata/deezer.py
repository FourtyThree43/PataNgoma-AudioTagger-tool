"""Deezer metadata provider plugin."""
...
class DeezerPlugin(BaseMetadataProvider, MetadataProviderPlugin):
    """Metadata provider plugin backed by Deezer API."""
