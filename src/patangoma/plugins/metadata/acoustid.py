"""AcoustID audio fingerprinting metadata provider plugin with cross-platform binary discovery."""
...
class AcoustIDPlugin(BaseMetadataProvider, MetadataProviderPlugin):
    """Metadata provider plugin backed by AcoustID fingerprint lookup API."""
...
AcoustIDProvider = AcoustIDPlugin
