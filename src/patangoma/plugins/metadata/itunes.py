"""iTunes Search API metadata provider plugin."""
...
class ITunesPlugin(BaseMetadataProvider, MetadataProviderPlugin):
    """Metadata provider plugin backed by Apple iTunes Search API (no API key required)."""
