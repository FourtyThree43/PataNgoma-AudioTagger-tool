...
@runtime_checkable
class AudioBackendPort(Protocol):
    """Protocol for reading and writing audio metadata tags and audio properties."""
...
class MediaFileAudioBackend:
    """Concrete audio metadata extraction and mutation backend using MediaFile/Mutagen."""
